// ---- Created with 3Dmigoto v1.3.16 on Thu Apr 16 12:01:25 2026
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xy = (int2)v6.xy;
  r0.zw = float2(0,0);
  r1.xyz = Viewport__GBufferNormalTexture__TexObj__.Load(r0.xyz).xyz;
  r0.x = Viewport__DepthVPSampler__TexObj__.Load(r0.xyw).x;
