// ---- Created with 3Dmigoto v1.3.16 on Sun Nov 09 21:39:17 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.yzw = r1.xyz * bloomScale.xyz * GS.Bloom + r0.yzw;
  r0.yzw = colorScale.xyz * r0.yzw;

  T_Color(r0.yzw);

  // r0.xyz = r0.yzw * r0.xxx; //Vignette applies here...
  T_Vignette(v2);
  ...
  // o0.w = dot(r0.xyz, float3(0.298999995,0.587000012,0.114)); //why BT601?
  // o0.xyz = r0.xyz;
  o0 = T_Out();
  return;
}